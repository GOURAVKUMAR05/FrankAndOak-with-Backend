    ...
    <section className='max-w-[1450px] mx-auto py-[50px] grid md:grid-cols-[40%_55%] sm:grid-cols-1 md:gap-0 gap-10 items-center justify-between lg:px-0 md:px-5 px-2'>
        ...
        <div className='grid grid-cols-2 gap-5 '>
            <div className='relative '>
                <img className='w-full h-full object-cover' src="https://www.frankandoak.com/cdn/shop/files/Tile_desktop_2_900x.jpg?v=1712334213" alt="Sustainable Practices" />
            ...
            <div className='relative'>
                <img className='w-full h-full object-cover' src="https://www.frankandoak.com/cdn/shop/files/story-design_900x.jpg?v=1712160804" alt="Design Philosophy" />
            ...
            <div className='relative'>
                <img className='w-full h-full object-cover' src="https://www.frankandoak.com/cdn/shop/files/Tile_desktop_3_900x.jpg?v=1712334263" alt="Fabrics Innovation" />
            ...
            <div className='relative'>
                <img className='w-full h-full object-cover' src="https://www.frankandoak.com/cdn/shop/files/story-partners_900x.jpg?v=1712160804" alt="Partners and Factories" />
