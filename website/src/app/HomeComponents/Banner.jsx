  ...
  return (
    <section className='w-full mt-10'>
        <div className='h-full  relative'>
            ...
            <img className='md:block hidden w-full h-full' src="https://www.frankandoak.com/cdn/shop/files/desktop-1_74fa8c87-61d9-49db-b06d-134319534051_2160x.jpg?v=1730839142" alt="Banner" />
